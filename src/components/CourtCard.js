    ...
    return (
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-base leading-none">{levelDot[p.level] || "🔵"}</span>
        ...
        <button
          ...
          onClick={() => {
            ...
            court.players.forEach((pId) => {
              onRemove(court.id, pId, true); // isEndGame = true (keeps your existing logic)
            });
          }}
        >
          End Game
